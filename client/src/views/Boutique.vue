 ...
 <template>
	<div>
        <div>
            ...
            <a-button @click="toggleOtherMenuItems">Connecter</a-button>
        </div>
		<!-- Authors Table -->
	...
	export default ({
		...
		data() {
			return {
                ...
                showOtherMenuItems: false,
			}
		},
        methods: {
            toggleOtherMenuItems() {
                // this.showOtherMenuItems = !this.showOtherMenuItems;
                // this.$emit('toggleAdditionalMenuItems', this.showOtherMenuItems);
                this.$emit('showOtherMenuItems');
