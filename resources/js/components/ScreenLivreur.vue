        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger rounded-pill px-4" data-dismiss="modal" @click="closeDetailsModal">Annuler</button>
            </div>
          </div>
        </div>
      </div>
      ...
      filteredCommandes(){
        ...
        if (this.search.client && this.search.client !== '') {
          filtered = filtered.filter((order) => {
            return order.client.last_name.toLowerCase().includes(this.search.client.toLowerCase()) || order.client.first_name.toLowerCase().includes(this.search.client.toLowerCase());
          });
        }
