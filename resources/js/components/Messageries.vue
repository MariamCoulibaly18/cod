    ...
    <div class="container-fluid">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10 d-flex align-items-center">
                          <select v-model="form.template_id" class="form-select" :class="{ 'is-invalid': form.errors.has('template.id') }">
                           ...
                           <button type="button" class="btn btn-Dark ml-2" @click="openTemplateModal">
                        ...
                        <div class="col-sm-10 d-flex align-items-center">
                          <select v-model="form.api_messagerie_id" class="form-select" :class="{ 'is-invalid': form.errors.has('apiMessagerie.id') }">
                           ...
                           <button type="button" class="btn btn-Dark ml-2" @click="openApiMessagerieModal">
                              <i class="fa fa-plus-square" aria-hidden="true" style="font-size: 30px;"></i>
                          </button>
                        </div>
                        </div>
      ...
      <!-- Modal for adding a Template -->
        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary rounded-pill px-4" @click="addTemplate">Ajouter</button>
                <button type="button" class="btn btn-danger rounded-pill px-4" data-dismiss="modal" @click="closeTemplateModal">Annuler</button>
            </div>
                  <!-- Select caché -->
                  <div v-if="showList" >
      ...
      <div class="modal fade" id="apiMessagerieModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary rounded-pill px-4" @click="addApiMessagerie">Ajouter</button>
                <button type="button" class="btn btn-danger rounded-pill px-4" data-dismiss="modal" @click="closeApiMessageModal">Annuler</button>
            </div>
            </div>
