<template>
  ...
  <div class="content" style="margin-top: -21px;">
    ...
    <div v-if="$gate.isSuperAdmin() || $gate.isAdmin() ">
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
      ...
      <div class="col-md-12" v-if="this.$store.getters.currentBoutique">
        <div class="row">
          <div class="col-lg-6">
            <div class="card">
              <div class="card-header border-0" style="background-color: #E5E6E7 !important;">
        ...
        loadCommandes(){
          ...
          loadVentes(){
              ...
              .then((response =>{
                  ...
                  this.ventesParMoisAnneePrecedente = response.data.ventesParMoisAnneePrecedente;
          ...
          createChart() {
            ...
            var nomsDesMoisEnFrancais = [
              'janvier', 'février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'
            ];
            var nomsDesMoisEnFrancaisDerniere = this.commandesParAnneeDerniere.map((item) => convertirMoisEnFrancais(item.dateDebut));
          ...
          createChartSales(){
            ...
            var nomsDesMoisEnFrancaisPrecedente = this.ventesParMoisAnneePrecedente.map((item) => convertirMoisEnFrancais(item.mois) );
              ...
              data: {
                ...
                datasets: [
                  ...
                  },
                  {
                    ...
                    borderColor: '#ced4da',
                    data: this.ventesParMoisAnneePrecedente.map((item) => item.totalVente),
                  }
                ]
              },
              options: {
                    ...
                    ticks: $.extend(
                        {
                          ...
                          suggestedMax: Math.max.apply(
                            ...
                            this.ventesParMoisAnneePrecedente.map((item) => item.totalVente)                           ),
