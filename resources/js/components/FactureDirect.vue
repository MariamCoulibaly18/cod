                    ...
                    <tbody>
                        <tr v-if="!isLoading" v-for="facture in paginatedFactureDirectes" :key="facture.id">
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-secondary" @click="viewPaymentHistory(facture)" title="Trace de paiement">
                                    <i class="fas fa-money-bill"></i>
                                </button>
                                <!-- export pdf -->
                                <button class="btn btn-sm btn-success" @click="downloadPDF(facture)" title="Exporter PDF">
                                    <i class="fas fa-file-pdf"></i>
                                </button>
                                <!-- envoyer par email -->
                                <button class="btn btn-sm btn-primary" @click="sendEmail(facture)" title="Envoyer par email">
                ...
                <div class="modal-body">
                    <form action="" @submit.prevent="addPayment">
                        <div class="d-flex align-items-center mb-3" v-if="factureEditee.status =='ouvert' && factureEditee.payment_status == 'incomplet'">
                            ...
                            <button class="btn btn-primary ms-2" type="submit" style="border-radius: 10px;">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="" @submit.prevent="createFacture">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <select name="client" id="client" class="form-select" v-model="facture.client">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" id="product" v-model="product.id" >
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger rounded-pill px-4" @click="resetForm">
                            <i class="fa fa-times"></i>
                            Annuler
                        </button>
                        <button class="btn btn-success rounded-pill px-4" type="submit" :disabled="isSubmitDisabled" >
