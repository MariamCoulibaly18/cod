            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                ...
                <form @submit.prevent="editMode ? updateTeamExpense() : createTeamExpense()">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select v-model="form.user_id" class="form-select" :class="{ 'is-invalid': form.errors.has('user.id') }">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger rounded-pill px-4" data-dismiss="modal" @click="closeAddModal()">Fermer</button>
