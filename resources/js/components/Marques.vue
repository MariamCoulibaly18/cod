            ...
            <div class="modal-dialog" role="document">
                ...
                <form @submit.prevent="editMode ? updateMarque() : createMarque()">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger rounded-pill px-4" data-dismiss="modal" @click="closeAddMarque()">Fermer</button>
                        <button type="submit" class="btn btn-primary rounded-pill px-4" v-show="!editMode">Creer</button>
