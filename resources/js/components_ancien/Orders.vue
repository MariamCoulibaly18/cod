        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeDetailsModal">Fermer</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div v-if="orderToModify" class="modal fade" id="modifierOrderModal" tabindex="-1" role="dialog" aria-labelledby="modifierOrderModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-primary" @click="updateOrderStatus()" :disabled="orderToModify.status === ''">Enregistrer</button>
              </div>
            </div>
          </div>
      </div>  
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form id="assigner-form" @submit.prevent="assignerLivreur()">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeAssignerLivreurModal()">Cancel</button>
