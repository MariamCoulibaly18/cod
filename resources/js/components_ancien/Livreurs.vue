            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeDetailsModal">Fermer</button>
                </div>
              </div>
            </div>
          </div>
    ...
    filteredlivreurs() {
      ...
      if (this.search.name !== '') {
        filtered = filtered.filter(livreur =>
          livreur.user.name.toLowerCase().startsWith(this.search.name.toLowerCase())
        );
      }

      if (this.search.adresse !== '') {
        filtered = filtered.filter(livreur =>
          livreur.adresse.toLowerCase().startsWith(this.search.adresse.toLowerCase())
        );
      }
