                          ...
                          <div class="spinner-container" v-if="isLoading">
                            ...
                            <thead>
                                ...
                                <th>
                                  ...
                                  <a @click="sortByTotal()" style="cursor:pointer">
                                    <i  class="ti ti-caret-up blue" v-if="this.search.total === 'asc'"></i>
                                    <i class="ti ti-caret-down blue" v-if="this.search.total === 'desc'"></i>
                                  </a>
                                </th>
                            ...
                            <tbody>
                                <tr v-if="!isLoading" v-for="transaction in paginatedTransactions" :key="transaction.id">
                                    ...
                                    <td>
                                        <button class="btn btn-secondary" @click="enleverTransaction(transaction.id)">
                                            <!-- annuler icon -->
                                            <i class="ti ti-rotate"></i>
                                        </button>
                                        <!-- if status is completed ,show the button of 'generate invoice'-->
                                        <button  class="btn btn-warning" v-if="transaction.isFactured === false" @click="generateInvoice(transaction)">
              ...
              <div class="modal-body">
                ...
                <form @submit.prevent="submitTransaction">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" v-model="form.produit_id" @change="updateSelectedProductName">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" v-model="form.fournisseur_id">
                  ...
                  <div class="modal-footer d-flex justify-content-center">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal" @click="closeAddModal()">Annuler</button>
            ...
            <div class="modal fade" id="marques_modal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeShowMarques()">Fermer</button>
                    </div>
                    </div>
                </div>
            </div>
