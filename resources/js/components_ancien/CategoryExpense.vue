<template>
    <div class="container-fluid">
      ...
      <div v-if="isDropdownVisible" class="provided">
         <a class="dropdown-item" @click="BusinessClick()" href="#"><i class="ti ti-briefcase"></i> Catégorie d'entreprise</a>
         <a class="dropdown-item" @click="TeamClick()" href="#"><i class="ti ti-users"></i>Catégorie d'equipe</a>
        </div>
      <div class="row">
        <div  v-if="!isLoading" v-for="(category, index) in paginatedCategoryType" :key="category.id" class="col-lg-4 mt-3">
          ...
          <div class="dropdown-menu" :class="{ 'show': activeDropdownIndex === index }">
                    <a class="dropdown-item" @click="editModal(category)" href="#"><i class="ti ti-edit"></i>Modifier</a>
                    <a class="dropdown-item" @click="deleteCategory(category.id)" href="#"><i class="ti ti-trash-x"></i>Supprimer</a>
          </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select v-model="form.parent_category_id" class="form-control" :class="{ 'is-invalid': form.errors.has('parent_category.id') }">
