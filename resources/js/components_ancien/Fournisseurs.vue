                ...
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        ...
                        <div class="col-8 mt-2 justify-content-center col-md-3">
                            <input type="text" class="form-control" style="font-size:13px" placeholder="fournisseur name" v-model="search.name" />
                        </div>
                        <!-- Adresse-->
                        <div class="col-8 mt-2 justify-content-center col-md-3">
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="fournisseur in paginatedFournisseurs" :key="fournisseur.id">
                                    ...
                                    <td>
                                        <a class="btn btn-success" @click="showMarques(fournisseur)">
                                            <i class="fa fa-eye white" ></i>
                                        </a>
                                        <a class="btn btn-dark ms-2" @click="addMarques(fournisseur)">
        ...
        <div >
         ...
         <div v-if="marqueAjoute">
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal" @click="closeBrandModal">Fermer</button>
                </div>
                </div>
            </div>
            </div>
        ...
        computed: {
            ...
            filteredFournisseur() {
                ...
                if (this.search.name && this.search.name !== '') {
                    ...
                    return fournisseur.name.toLowerCase().startsWith(this.search.name.toLowerCase());
                });
                }
                if (this.search.adresse && this.search.adresse !== '') {
                filteredFournisseur = filteredFournisseur.filter((fournisseur) => {
                return fournisseur.adresse && fournisseur.adresse.toLowerCase().startsWith(this.search.adresse.toLowerCase());
                });
            }
