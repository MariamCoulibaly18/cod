            ...
            <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 800px;">
                ...
                <form @submit.prevent="editMode ? updateClient() : createClient()">
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-danger" data-dismiss="modal" @click="closeModal">Fermer</button>
            ...
            filteredClients(){
                ...
                if(this.search.name != ''){
                    filtered = filtered.filter(client => {
                        return client.first_name.toLowerCase().startsWith(this.search.name.toLowerCase()) || client.last_name.toLowerCase().startsWith(this.search.name.toLowerCase());
                    })
                }
                ...
                if(this.search.email != ''){
                    filtered = filtered.filter(client => {
                        return client.email.toLowerCase().startsWith(this.search.email.toLowerCase());
                    })
                }
